...
public class ATMFraudSchema implements DeserializationSchema<ATMFraudEvent>, 
									SerializationSchema<ATMFraudEvent> {
		// Chuyển đổi bype[] thành ATMFrauEvent và ngược lại
